...
// }else{
$statement = $pdo->prepare('SELECT * FROM products2 WHERE category = "automobile" ORDER BY id');
$statement->execute();
$products = $statement->fetchAll(PDO::FETCH_ASSOC);

$statement1 = $pdo->prepare('SELECT * FROM newarrival WHERE category = "automobile" ORDER BY id');
$statement1->execute();
...
?>    
    ...
    <div class="container" id="storetags">
      <h3 style="text-align:center">automobiles</h3>
    </div>
