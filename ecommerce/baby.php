...
// }else{
$statement = $pdo->prepare('SELECT * FROM products2 WHERE category = "baby" ORDER BY id');
$statement->execute();
$products = $statement->fetchAll(PDO::FETCH_ASSOC);

$statement1 = $pdo->prepare('SELECT * FROM newarrival WHERE category = "baby" ORDER BY id');
$statement1->execute();
